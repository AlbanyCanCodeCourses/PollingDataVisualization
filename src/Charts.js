...
import "./App.css";
import { avg, calculateMedian, parseCurrency } from "./utils/stats.js";
 ...
 * UPDATE: Extracted all repeated stats function into ./util/stats.js
 */
...
const Charts = props => {
  ...
  let data = [
    {
      category: "Overall",
      value: overall ? avg(d0) : null
    },
    {
      category: "Multiple Classes",
      value: multipleClasses ? avg(d0) : null
    },
    {
      category: "Single Class",
      value: singleClass
        ? avg(d0.filter(obj => obj.number_of_classes === 1))
        : null
    },
    {
      category: "Median",
      value: median
        ? calculateMedian(
            d0
              .map(obj => parseCurrency(obj.salary_change))
              .sort((a, b) => a - b)
          )
        : null
    },
    {
      category: "Women",
      value: women ? avg(d0.filter(obj => obj.gender === "Female")) : null
    },
    {
      category: "POC",
      value: poc ? avg(d0.filter(obj => obj.demographic !== "W")) : null
    }
